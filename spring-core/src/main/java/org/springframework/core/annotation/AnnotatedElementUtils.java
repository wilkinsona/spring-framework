...
public abstract class AnnotatedElementUtils {
	...
	public static boolean hasMetaAnnotationTypes(AnnotatedElement element, Class<? extends Annotation> annotationType) {
		return getAnnotations(element).stream(annotationType).anyMatch(
	...
	public static boolean hasMetaAnnotationTypes(AnnotatedElement element, String annotationName) {
		return getAnnotations(element).stream(annotationName).anyMatch(
				MergedAnnotation::isMetaPresent);
	}
	...
	public static AnnotationAttributes getMergedAnnotationAttributes(
		...
		return getAnnotations(element).getFirst(annotationType).asMap(
	...
	public static AnnotationAttributes getMergedAnnotationAttributes(AnnotatedElement element,
		...
		return getAnnotations(element).getFirst(annotationName).asMap(
				AnnotationAttributes::createIfAnnotationPresent,
	...
	public static <A extends Annotation> A getMergedAnnotation(AnnotatedElement element, Class<A> annotationType) {
		return getAnnotations(element).getFirst(annotationType).synthesize(
	...
	public static <A extends Annotation> Set<A> getAllMergedAnnotations(AnnotatedElement element, Class<A> annotationType) {
		return getAnnotations(element).stream(annotationType).collect(
	...
	public static Set<Annotation> getAllMergedAnnotations(AnnotatedElement element, Set<Class<? extends Annotation>> annotationTypes) {
		return getAnnotations(element).stream().filter(
	...
	public static MultiValueMap<String, Object> getAllAnnotationAttributes(AnnotatedElement element,
		...
		return getAnnotations(element).stream(annotationName).filter(
	...
	public static AnnotationAttributes findMergedAnnotationAttributes(AnnotatedElement element,
		...
		return findAnnotations(element).getFirst(annotationType).asMap(
				AnnotationAttributes::createIfAnnotationPresent,
				MapValues.of(classValuesAsString, nestedAnnotationsAsMap));
	}
	...
	public static AnnotationAttributes findMergedAnnotationAttributes(AnnotatedElement element,
			String annotationName, boolean classValuesAsString, boolean nestedAnnotationsAsMap) {
		return findAnnotations(element).getFirst(annotationName).asMap(
				AnnotationAttributes::createIfAnnotationPresent,
				MapValues.of(classValuesAsString, nestedAnnotationsAsMap));
	}
	...
	public static <A extends Annotation> A findMergedAnnotation(AnnotatedElement element, Class<A> annotationType) {
		return findAnnotations(element).getFirst(annotationType).synthesize(
				MergedAnnotation::isPresent).orElse(null);
	}
	...
	public static <A extends Annotation> Set<A> findAllMergedAnnotations(AnnotatedElement element, Class<A> annotationType) {
		return findAnnotations(element).stream(annotationType).sorted(
	...
	public static Set<Annotation> findAllMergedAnnotations(AnnotatedElement element, Set<Class<? extends Annotation>> annotationTypes) {
		return findAnnotations(element).stream().filter(
